...
class AccessoiresPage extends StatelessWidget {
   AccessoiresPage({super.key});


   

  final CollectionReference _accessoires= FirebaseFirestore.instance.collection('accessoires');
    ...
    builder: (context) {
      return AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              await _accessoires.doc(data.id).update({
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    IconButton(
                                                      ...
                                                      onPressed: () async {
                                                        await _accessoires.doc(data.id).delete();
                                                      },
                                                    ),
                                                  ],
                                                ),
