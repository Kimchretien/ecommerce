...
class GamingPages extends StatelessWidget {
   GamingPages({super.key});


   

  final CollectionReference _gaming= FirebaseFirestore.instance.collection('gaming');
    ...
    builder: (context) {
      return AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              await _gaming.doc(data.id).update({
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    IconButton(
                                                      ...
                                                      onPressed: () async {
                                                        await _gaming.doc(data.id).delete();
                                                      },
                                                    ),
                                                  ],
                                                ),
